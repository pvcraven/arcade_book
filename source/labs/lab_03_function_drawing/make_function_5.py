...
def draw_tractor(x, y):
    ...
    # Draw the engine
    arcade.draw_rect_filled(arcade.XYWH(600 - 490 + x, 120 - 90 + y, 140, 70), arcade.color.GRAY)
    arcade.draw_rect_filled(arcade.XYWH(590 - 490 + x, 105 - 90 + y, 90, 40), arcade.color.BLACK)

    # Draw the smoke stack
    arcade.draw_rect_filled(arcade.XYWH(580 - 490 + x, 175 - 90 + y, 10, 40), arcade.color.BLACK)
