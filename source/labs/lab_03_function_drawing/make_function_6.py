...
def draw_tractor(x, y):
    ...
    # Draw the engine
    arcade.draw_rect_filled(arcade.XYWH(110 + x, 30 + y, 140, 70), arcade.color.GRAY)
    arcade.draw_rect_filled(arcade.XYWH(100 + x, 15 + y, 90, 40), arcade.color.BLACK)

    # Draw the smoke stack
    arcade.draw_rect_filled(arcade.XYWH(90 + x, 85 + y, 10, 40), arcade.color.BLACK)
