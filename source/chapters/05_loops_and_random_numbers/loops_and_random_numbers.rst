...
Figure 4.1 shows the game Eve Online and a graph showing how many frames
...
The loop in these games works like the flowchart in Figure 4.2. Despite the
...
draws each frame of the game, which looks like Figure 4.3.
...
A program does not need to name the variable i, it could be named something else. For example a programmer might use lineNumber if she was processing a text file.
...
Print the numbers 1 to 10, version 1
1
2
for i in range(1, 11):
    print(i)
...
Print the numbers 1 to 10, version 2
1
2
3
...
2
1
If the numbers that a program needs to iterate through don't form an easy pattern, it is possible to pull numbers out of a list. (A full discussion of lists is covered in Chapter 7. This is just a preview of what you can do.)
...
4.3.1 Using Increment Operators
...
while i <= 2 ** 32:
    print(i)
    i *= 2
4.3.2 Looping Until User Wants To Quit
...
while value < 0.999:
    ...
    increment *= 0.5
    print(value)
4.3.3 Common Problems With while Loops
...
What if you don't want a number, but a random item? That requires a list. We don't cover lists in detail until Chapter 7, but to give you preview of what selecting a random item out of a list would look like, see below:

Picking a random item out of a list
my_list = ["rock", "paper", "scissors"]
random_index = random.randrange(3)
print(my_list[random_index])
4.5.2 The random Function
